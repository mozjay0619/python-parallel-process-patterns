...
class WorkerThread(Thread):
    ...
    """
    def __init__(self, worker, task_queue, result_queue, idle_worker_queue, work_done_event):
    ...
    def run(self):
        ...
        try:
            print("worker finished work {}".format(task))
        except:
            print("worker had nothing to do")
...
class WorkScheduler:
    ...
    """
    def __init__(self, tasks_list, workers):
    ...
    def run(self):
        ...
        while True:
            ...
            print('Giving worker {} the work {}'.format(5, self.task_queues_pos))
            ...
            self.work_done_events = [_work_done_event 
                                     for _work_done_event 
                                     in self.work_done_events 
                                     if not work_done_event.isSet()] + [work_done_event]
